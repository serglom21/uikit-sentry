...
#ifndef UIKITSENTRYDEMO_SWIFT_H
#define UIKITSENTRYDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UIKitSentryDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15UIKitSentryDemo11AppDelegate")
...
@class UIScene;
SWIFT_CLASS("_TtC15UIKitSentryDemo13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC15UIKitSentryDemo14ViewController")
